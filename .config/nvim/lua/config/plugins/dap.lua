return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<S-j>", function() dap.step_over() end, { noremap = true, silent = true, desc = "Step Over" })
        vim.keymap.set("n", "<leader>dq", function() dap.close() end, { noremap = true, silent = true, desc = "Stop Debugger" })
        vim.keymap.set("n", "<leader>dn", function() dap.continue() end, { noremap = true, silent = true, desc = "Open/Continue Debugger" })
        vim.keymap.set("n", "<leader>dk", function() dap.up() end, { noremap = true, silent = true, desc = "Move Up Stack Frame" })
        vim.keymap.set("n", "<leader>dj", function() dap.down() end, { noremap = true, silent = true, desc = "Move Down Stack Frame" })
        vim.keymap.set("n", "<leader>du", function() dap.run_last() end, { noremap = true, silent = true, desc = "Run Last Configuration" })
        vim.keymap.set("n", "<leader>dr", function() dap.repl.open({}, "vsplit") end, { noremap = true, silent = true, desc = "Open REPL" })
        vim.keymap.set("n", "<leader>d?",
            function()
                local widgets = require("dap.ui.widgets"); widgets.centered_float(widgets.scopes)
            end, { noremap = true, silent = true, desc = "Scopes Hover Window" })
        vim.keymap.set("n", "<leader>de", function() dap.set_exception_breakpoints({ "all" }) end, { noremap = true, silent = true, desc = "Exception Breakpoints" })
